...
DiscordCallback = https://localhost:8377/auth/oauth/discord/callback

GoogleClientID = {google_client_id}
GoogleClientSecret = {google_client_secret}
GoogleCallback = https://localhost:8377/auth/oauth/google/callback

GithubClientID = {github_client_id}
GithubClientSecret = {github_client_secret}
GithubCallback = https://localhost:8377/auth/oauth/github/callback

MicrosoftClientID = {microsoft_client_id}
MicrosoftClientSecret = {microsoft_client_secret}
MicrosoftCallback = https://localhost:8377/auth/oauth/microsoftonline/callback
